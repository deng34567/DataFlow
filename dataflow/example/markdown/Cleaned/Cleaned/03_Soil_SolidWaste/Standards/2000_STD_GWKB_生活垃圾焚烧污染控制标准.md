...
$B$ ——焚烧炉渣经 $600 \pm 25^{\circ} \mathrm{C} 3 \mathrm{~h}$ 灼热，然后冷却至室温后的质量，g。
...
$$
\mathrm {T E Q} = \sum (\text {二噬英毒性同类物浓度} \times \mathrm {T E F})
$$
...
注：*在同一广区内如同时有多台垃圾焚烧炉，则以各焚烧炉处理量总和作为评判依据。

7.2.2 焚烧炉烟囱周围半径 $200\mathrm{m}$ 距离内有建筑物时，烟囱应高出最高建筑物 $3\mathrm{m}$ 以上，不能达到该要求的烟囱，其大气污染物排放限值应按表3规定的限值严格 $50\%$ 执行。
...
| 3   | 一氧化碳 | mg/m³     | 小时均值  | 150 |
| 4   | 氮氧化物 | mg/m³     | 小时均值  | 400 |
| 5   | 二氧化硫 | mg/m³     | 小时均值  | 260 |
| 6   | 氯化氢  | mg/m³     | 小时均值  | 75  |
| 7   | 汞    | mg/m³     | 测定均值  | 0.2 |
| 8   | 镉    | mg/m³     | 测定均值  | 0.1 |
| 9   | 铅    | mg/m³     | 测定均值  | 1.6 |
| 10  | 二噁英类 | ng TEQ/m³ | 测定均值  | 1.0 |


注：1）本表规定的各项标准限值，均以标准状态下含 $11\% \mathrm{O_2}$ 的干烟气为参考值换算。
...
生活垃圾焚烧厂工艺废水排放限值生活垃圾焚烧厂工艺废水必须经废水处理系统处理，处理后的水应优先考虑循环再利用，必须排放时，废水中污染物最高允许排放浓度按GB8978执行。
...
10.3.1.2 本标准规定的小时均值是指以连续 $1\mathrm{h}$ 的采样获取的平均值，或在 $1\mathrm{h}$ 内，以等时间间隔至少采取3个样品计算的平均值。
...
其他尾气净化装置排放的固体废物按GB5086.1～5086.2做浸出试验，按GB/T15555.1～
